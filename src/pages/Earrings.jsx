  ...
  useEffect(() => {
    async function loadProducts() {
      try {
        ...
        console.error(
          'Failed to load earrings:',
          error
        )

        setError(
          error.message ||
            'Unable to load earrings right now.'
        )
      } finally {
        setLoading(false)
      }
    ...
    <div className="category-products-page">
      ...
      <main>
        ...
        <section className="category-products-hero">
          ...
          <p>
            Discover beautiful earrings designed
            to add elegance to every look.
          </p>
        ...
        <section className="category-products-section">
          ...
          {/* ================================
              PRODUCT GRID
              SAME STRUCTURE AS ALL PRODUCTS
          ================================= */}
